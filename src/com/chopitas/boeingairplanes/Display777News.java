...
import com.chopitas.boeingairplanes.Display767News.loadRSSFeedItems;
...
public class Display777News extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        String rss_link = "http://boeing.mediaroom.com/index.php?s=43&pagetemplate=rss&category=6";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_display777_news, menu);
		return true;
	}
