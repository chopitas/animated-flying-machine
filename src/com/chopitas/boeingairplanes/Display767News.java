...
import com.chopitas.boeingairplanes.Display747News.loadRSSFeedItems;
...
public class Display767News extends ListActivity {
  ...
  private static String TAG_PUB_DATE = "pubDate";
	...
	protected void onCreate(Bundle savedInstanceState) {
 	...
 	// get intent data
	        ...
	        String rss_link = "http://boeing.mediaroom.com/index.php?s=43&pagetemplate=rss&category=5";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_display767_news, menu);
		return true;
	}
