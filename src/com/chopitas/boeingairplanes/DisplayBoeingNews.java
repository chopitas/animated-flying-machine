...
public class DisplayBoeingNews extends ListActivity {
...
//        Integer site_id = Integer.parseInt(i.getStringExtra("id"));
        ...
        */
        ...
        String rss_link = "http://boeing.mediaroom.com/index.php?s=43&pagetemplate=rss&category=2";
...
//                Toast.makeText(getApplicationContext(), page_url, Toast.LENGTH_SHORT).show();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_display_boeing_news, menu);
		return true;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_boeing_news);
		// Show the Up button in the action bar.
		getActionBar().setDisplayHomeAsUpEnabled(true);
	}
