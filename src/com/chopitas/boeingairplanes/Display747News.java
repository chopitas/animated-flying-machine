...
import com.chopitas.boeingairplanes.Display737News.loadRSSFeedItems;
...
public class Display747News extends ListActivity {
   ...
   private static String TAG_PUB_DATE = "pubDate";
		...
		int versionNumber = Integer.valueOf(android.os.Build.VERSION.SDK_INT);
 		...
 		getActionBar().setDisplayHomeAsUpEnabled(true);
 	 	...
 	 	// get intent data
 	        ...
 	        String rss_link = "http://boeing.mediaroom.com/index.php?s=43&pagetemplate=rss&category=4";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_display747_news, menu);
		return true;
	}
