...
public class Display737News extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
 	...
 	// get intent data
        ...
        String rss_link = "http://boeing.mediaroom.com/index.php?s=43&pagetemplate=rss&category=3";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_display737_news, menu);
		return true;
	}
