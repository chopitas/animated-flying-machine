...
public class DisplayTupolev extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_tupolev);
        ...
        listView = (ListView) findViewById(R.id.tupolevList);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_display_tupolev, menu);
		return true;
	}
			    ...
			    public void onItemClick(AdapterView<?> parent, View view, int position,
			    	...
			    	switch(position){
				  	case 0:
				  		...
				  		String url = "http://www.tupolev.ru/english/Show.asp?SectionID=35";
				  		...
				  		/*
			               Intent in = new Intent(getApplicationContext(), DisPlayWebPageActivity.class);
			                ...
			                // getting page url
			                String page_url = "http://www.tupolev.ru/english/Show.asp?SectionID=35";
