...
public class DisplayEmbraerNews extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        String rss_link = "http://www.embraer.com/resources/nuova.MOSS/Pages/SuperRSS.aspx?lk=URL%20Absoluta%20Codificada&u=http://www.embraer.com/en-US/ImprensaEventos/Press-releases/Noticias&l=Pages&ct=T%EDtulo&cd=Chamada&vf=&o=Data&ex=&clickurl=&campidioma=&idioma=&titulorss=Press%20and%20Events&descricaorss=News&cdt=data&rl=10";
...
//                Toast.makeText(getApplicationContext(), page_url, Toast.LENGTH_SHORT).show();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_display_embraer_news, menu);
		return true;
	}
