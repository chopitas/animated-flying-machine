...
public class DisplayBombardierNews extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        String rss_link = "http://www.bombardier.com/files/en/feeds/rss.xml";
...
//                Toast.makeText(getApplicationContext(), page_url, Toast.LENGTH_SHORT).show();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater()
				.inflate(R.menu.activity_display_bombardier_news, menu);
		return true;
	}
